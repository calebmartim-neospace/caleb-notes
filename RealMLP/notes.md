...
composto por 90 datasets, esses resultados são comparados com versões de
híper-paramêtros otimizados (Abstract, linha 5-9). Sob os datasets de teste, o
RealMLP mostra um melhor custo-benefício entre tempo e precisão comparado com
outros modelos neurais e seus resultados são comparáveis com o de GBDTs. Além
disso, uma combinação de RealMLP e GBDTs com parâmetros padrões melhorados
